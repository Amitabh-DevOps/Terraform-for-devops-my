...
#   description = "The name of the DynamoDB table used for state locking and consistency checks."
#   type        = string
#   default     = "terraform-db"
# }

# variable "aws_dynamodb_table_key" {
#   description = "The key or path within the S3 bucket where the Terraform state file will be stored."
#   type        = string
